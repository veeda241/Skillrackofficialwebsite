...
import type { HackathonUpdatesOutput } from '@/app/types/hackathon-updates';

// In a real application, you would fetch this data from a database.
// For now, we are returning a static list of hackathons.
const MOCK_HACKATHONS: HackathonUpdatesOutput = {
  hackathons: [
    {
